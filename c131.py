...
for index,name in enumerate(planet_names):
    gravity = (float(planet_mass[index])*5.972e+24)/(float(planet_radiuses[index])*float(planet_radiuses[index])*6371000*6371000)*6.674e-11
    planet_gravity.append(gravity)

#fig = px.scatter(x=planet_radiuses,y = planet_mass, size = planet_gravity, hover_data = [planet_names])
#fig.show()
